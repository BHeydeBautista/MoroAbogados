...
export const carlosArticles: Article[] = [
  ...
  // ERRAPAR (Doctrina societaria y concursal) - agregar entradas listadas
  {
    slug: "errapar-un-privilegiado-en-la-ley-concursal",
    title: "Un Privilegiado En La Ley Concursal, 'Super Privilegiado' Por La Ley De Prenda Con Registro",
    autor: "Carlos E. Moro",
    fuente: "ERRAPAR (Doctrina Societaria y Concursal)",
    fecha: "",
